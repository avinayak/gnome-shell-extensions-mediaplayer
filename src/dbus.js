...
export function DBus() {
  return new DBusProxy(Gio.DBus.session, 'org.freedesktop.DBus',
    '/org/freedesktop/DBus');
}

export function Properties(owner, callback) {
  return new PropertiesProxy(Gio.DBus.session, owner,
    '/org/mpris/MediaPlayer2',
    callback);
}

export function MediaServer2(owner, callback) {
  return new MediaServer2Proxy(Gio.DBus.session, owner,
    '/org/mpris/MediaPlayer2',
    callback);
}

export function MediaServer2Player(owner, callback) {
  return new MediaServer2PlayerProxy(Gio.DBus.session, owner,
    '/org/mpris/MediaPlayer2',
    callback);
}

export function MediaServer2Playlists(owner, callback) {
  return new MediaServer2PlaylistsProxy(Gio.DBus.session, owner,
    '/org/mpris/MediaPlayer2',
    callback);
}

export function MediaServer2Tracklist(owner, callback) {
  return new MediaServer2TracklistProxy(Gio.DBus.session, owner,
    '/org/mpris/MediaPlayer2',
    callback);
}

export function PithosRatings(owner, callback) {
...
export function RatingsExtension(owner, callback) {
...
export function RhythmboxRatings(owner) {
